...
This SDK is mostly interpreted from the official one, but the quality of code has been improved compared with the unreasonable style in the original one.
    ...
    s.homepage         = 'https://github.com/greedbell/AliyunLogObjc'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'Bell' => 'bell@greedlab.com' }
    s.source           = { :git => 'https://github.com/greedbell/AliyunLogObjc.git', :tag => s.version.to_s }
